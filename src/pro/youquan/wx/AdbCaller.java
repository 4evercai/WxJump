...
public class AdbCaller {
	...
	public static String adbPath = Constants.ADB_PATH;
	 ...
	 * @param timeMilli
	 */
	public static void longPress(int x,int y,double timeMilli) {
		try {
                       String cmd = adbPath + " shell input touchscreen swipe "+x+ " "+y+ " "+x+ " "+y+ " " + (int) timeMilli;
